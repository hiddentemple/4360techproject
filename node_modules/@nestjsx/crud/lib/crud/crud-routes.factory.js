...
class CrudRoutesFactory {
    ...
    getPrimaryParam() {
        return util_1.objKeys(this.options.params).find((param) => this.options.params[param] && this.options.params[param].primary);
    }
    ...
    setSwaggerPathParams(name) {
        ...
        const params = util_1.isIn(name, withoutPrimary)
            ? util_1.objKeys(this.options.params).reduce((a, c) => this.options.params[c].primary ? a : { ...a, [c]: this.options.params[c] }, {})
            : this.options.params;
