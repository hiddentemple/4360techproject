...
exports.swagger = util_2.safeRequire('@nestjs/swagger');
exports.swaggerConst = util_2.safeRequire('@nestjs/swagger/dist/constants');
exports.swaggerPkgJson = util_2.safeRequire('@nestjs/swagger/package.json');
class Swagger {
    ...
    static createQueryParamsMeta(name) {
        ...
        const { delim: d, delimStr: coma, fields, search, filter, or, join, sort, limit, offset, page, cache, } = Swagger.getQueryParamsNames();
        const oldVersion = Swagger.getSwaggerVersion() < 4;
